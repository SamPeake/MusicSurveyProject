...
public class DisplayWindow {
     ...
     */
    public DisplayWindow(GraphSolver solver) {
        this.solver = solver;
        dimension = 0;
        window = new Window();
    ...
    private void addLegend() {
        Shape legendBorder = new Shape(0, (window.getGraphPanelHeight() * 9) / 10, window.getGraphPanelWidth(), 5, Color.BLACK);
        ...
        //hobby
            ...
            TextShape category1 = new TextShape(x, y, "reading", getColor(dimension, 1));
            category1.setX(x - (category1.getWidth() / 2));
            x = x * 3;
            TextShape category2 = new TextShape(x, y, "sports", getColor(dimension, 2)); 
            category2.setX(x - (category2.getWidth() / 2));
            x = (x / 3) * 5;
            TextShape category3 = new TextShape(x, y, "arts", getColor(dimension, 3)); 
            category3.setX(x - (category3.getWidth() / 2));
            x = (x / 5) * 7;
            
            TextShape category4 = new TextShape(x, y, "music", getColor(dimension, 4)); 
            category4.setX(x - (category4.getWidth() / 2)); 
        }
        //location
        else {
    ...
    private void placeEntry(Position column, Position row, int index) {
        ...
        x = (window.getGraphPanelWidth() * (columnFactor / 6))
                - (genre.getWidth() / 2);
        y = (window.getGraphPanelHeight() * (rowFactor / 6)) - title.getHeight()
                - this.LEGEND_GAP;
        genre.setX(x);
        genre.setY(y);
    ...
    private void placeGraph(Position column, Position row, int index) {
        ...
        if (column == Position.FrontEnum) {
            ...
            x1 = ((window.getGraphPanelWidth() * 5) / 6)
                    - (axis.getWidth() / 2);
            axis.setX(x1);
            x1 = axis.getX() + axis.getWidth();
        ...
        if (row == Position.FrontEnum) {
            ...
            y = (((window.getGraphPanelHeight() - this.LEGEND_GAP) * 5) / 6)
                    + 5;
            axis.setY(y);
        }
